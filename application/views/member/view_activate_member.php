			...
			<div class="col-sm-12">
                <section class="panel">
                    ...
                    <div class="panel-body">
						<form action="<?php echo base_url();?>member/update_activate_member" class="horizontal-form" id="form_sample_1" method="post">
							<div class="form-body">
								<div class="row">
									<div class="col-md-4">
									</div>
									...
									<div class="col-md-4">
										<div class="form-group">
											<label class="control-label">Member Activate Here </label>
											<input type="hidden" id="txtquid" name="txtquid" class="form-control empty" >
											<button type="button" class="btn btn-primary" onclick="conwv('form_sample_1')">Activate</button>
										</div>
									</div>
									<div class="col-md-4">
									</div>
