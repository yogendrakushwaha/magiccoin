			...
			<div class="col-lg-6">
				<section class="panel corner-flip">
					...
					<div class="panel-body">
						<form class="form-horizontal" parsley-validate action="<?php echo site_url('userprofile/update_perfect_details/'.$perfect->m_pfect_id); ?>" method="post" data-collabel="3" data-alignlabel="left" id="insert_data">
							...
							<div class="form-group">
								...
								<div>
									...
									<script>
										$("#ddcurrency").val("<?php echo $perfect->m_pfect_currtype_id; ?>");
									</script>
