			...
			<div class="col-lg-12">
				<section class="panel">
					...
					<div class="panel-body">
						<div class="form">
							<form action="<?php echo base_url();?>member/update_details" class="horizontal-form"  id="signupForm" method="post">
								<div class="form-body">
									<div class="row">
										<div class="col-md-6">
											<div class="form-group">
												<label class="control-label">Enter Associate ID</label>
												
												<input type="text" id="distributor_id" name="distributor_id" class="form-control input-inline input-medium" placeholder="Enter Distributor ID." value="<?php if($uid!=""){ echo $uid;}?>"><br>
							...
							<?php
								if($uid != '')
								{
									...
									<!-- BEGIN FORM-->
									<hr>
									<form action="<?php echo site_url('member/update_member'); ?>" class="horizontal-form"  id="signupForm1" method="post" enctype="multipart/form-data">
										<div class="form-body">
											<!--/row-->
											...
											<div class="row">
												...
												<div class="col-md-4">
													<div class="form-group">
														...
														<input type="text" class="form-control" name="txtpincode" id="txtpincode" value="<?php echo $rinfo->USER_PINCODE;?>">										
													</div>
												</div>
											</div>
											...
											<div class="row">
												<div class="col-md-4">
													<div class="form-group">
														...
														<input type="text" class="form-control" name="txtmobile" id="txtmobile" maxlength="10" <?php echo ($rinfo->USER_MOBILE)?'readonly':''; ?> value="<?php echo $rinfo->USER_MOBILE;?>">	
												...
												<div class="col-md-4">
													<div class="form-group">
														...
														<input type="text" class="form-control" name="txtemail" id="txtemail" <?php echo ($rinfo->USER_EMAIL)?'readonly':''; ?> value="<?php echo $rinfo->USER_EMAIL;?>">
