			...
			<div class="col-lg-6">
				<section class="panel corner-flip">
					...
					<div class="panel-body">
						<form class="form-horizontal" parsley-validate action="<?php echo site_url('userprofile/update_password'); ?>" method="post" data-collabel="3" data-alignlabel="left" id="insert_data" onsubmit="return check_pass()">
							
							<div class="form-group">
								<label class="control-label">Old Password</label>
								<div>
									<input type="password"  parsley-required="true"   parsley-trigger="keyup" id="txtoldpassword" name="txtoldpassword" class="form-control" empty="yes" err_msg="Is Required" placeholder="Enter Old Password." value="" onblur="validte_password();">
