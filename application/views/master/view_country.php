			...
			<div class="col-lg-6">
				<section class="panel">
					...
					<div class="panel-body">
						<div class="form">
							<form class="form-horizontal" role="form" action="<?php echo base_url().'index.php/master/add_country/'?>" method="post" id="signupForm">
								<div class="form-body" id="city">
									
									<div class="form-group">
										<label class="col-md-3 control-label">Country Name</label>
										<div class="col-md-9">
											<input type="text" id="txtcounrty" name="txtcounrty" class="form-control input-inline input-medium" placeholder="Enter Country Name">
									...
									<div class="form-group">
										...
										<div class="col-md-9">
											<input type="text" id="txtisocode" name="txtisocode" class="form-control input-inline input-medium" placeholder="Enter ISO Code Name">
											<span class="help-inline">
									...
									<div class="form-group">
										...
										<div class="col-md-9">
											<input type="text" id="txtisoccode1" name="txtisoccode1" class="form-control input-inline input-medium" placeholder="Enter Other ISO Code Name">
											<span class="help-inline">
									...
									<div class="form-group">
										...
										<div class="col-md-9">
											<input type="text" id="txtaddressformat" name="txtaddressformat" class="form-control input-inline input-medium" placeholder="Enter Country Address Format ">
											<span class="help-inline">
									...
									<div class="form-group">
										...
										<div class="col-md-9">
											<div class="radio-list">
												...
												<input type="radio" name="rdpostal" id="rdpostal1" value="1" checked onClick="check1('1')"> Yes</label>
												<label class="radio-inline">
												<input type="radio" name="rdpostal" id="rdpostal2" value="0"  onClick="check1('0')"> No</label>
									...
									<div class="form-group">
										...
										<div class="col-md-9">
											<div class="radio-list">
												<label class="radio-inline">
												<input type="radio" name="rbcity" id="rbcity1" value="1" checked onClick="check2('1')"> Enable</label>
												<label class="radio-inline">
												<input type="radio" name="rbcity" id="rbcity2" value="0"  onClick="check2('0')"> Disable</label>
