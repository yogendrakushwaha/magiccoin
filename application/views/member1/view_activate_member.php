...
<div id="main">
	...
	<ol class="breadcrumb">
		...
		<li class="active"><a href="#">Activate Menber</a></li>
	</ol>
	<!-- //breadcrumb-->
			...
			<div class="col-lg-12">
				<section class="panel">
					<header class="panel-heading sm">
						<h2><strong>View </strong> Deactivate Member </h2>
					</header>
					...
					<div class="panel-body">
						<form action="<?php echo base_url();?>index.php/member/update_activate_member" method="post">
							<div class="form-group offset" align="center">
								<div>
									<input type="hidden" id="txtquid" name="txtquid" >
									<button type="submit" class="btn btn-theme">Activate Member</button>
								</div>
							</div>
