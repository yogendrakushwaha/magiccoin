			...
			<div class="col-lg-12">
				<section class="panel">
					...
					<div class="panel-body">
						<form class="horizontal-form" action="<?php echo site_url('userprofile/view_user_downline'); ?>" method="post" id="insert_data">
							...
							<div class="col-md-4">
								...
								<div class="form-group">
									<input type="text" id="txtuserid" name="txtuserid" class="form-control empty" readonly value="<?php echo $this->session->userdata('user_id'); ?>" placeholder="Enter User Id.">
