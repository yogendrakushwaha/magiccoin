			...
			<div class="col-lg-12">
				<section class="panel">
					...
					<div class="panel-body">
						<div class="form">
							<form action="<?php echo base_url(); ?>userprofile/get_tree" class="horizontal-form" method="post">
		...
		<?php
			if($s==1)
			{
				...
				else
				{
					...
					$member_id=$this->session->userdata('profile_id');
				}
			}
			else
			{
					...
					<div class="panel-body">
						...
						<?php
							...
							<div style="float:left; padding:10px; width:50%; height:100px; text-align:center;">
								<a href="<?php echo base_url();?>userprofile/tree/<?php echo $result1->USER_REGID; ?>">
						...
						<?php
							...
							?>
							<div style="float:left; padding:10px; width:50%; height:100px; text-align:center;">
								<a href="<?php echo base_url();?>userprofile/tree/<?php echo $result2->USER_REGID; ?>">
						...
						<?php
							...
							<div style="padding:10px; float:left; width:25%; height:100px; text-align:center;">
								<a href="<?php echo base_url();?>userprofile/tree/<?php echo $result11->USER_REGID; ?>">
						...
						<?php
							...
							?>
							<div style="padding:10px; float:left; width:25%; height:100px; text-align:center;">
								<a href="<?php echo base_url();?>userprofile/tree/<?php echo $result12->USER_REGID; ?>">
						...
						<?php 
							...
							?>
							<div style="padding:10px; float:left; width:25%; height:100px; text-align:center;">
								<a href="<?php echo base_url();?>userprofile/tree/<?php echo $result21->USER_REGID; ?>">
						...
						<?php
							...
							?>			
							<div style="padding:10px; float:left; width:25%; height:100px; text-align:center;">
								<a href="<?php echo base_url();?>userprofile/tree/<?php echo $result22->USER_REGID; ?>">
						...
						<?php
							...
							<div style="padding:10px; float:left; width:12.5%; height:180px; text-align:center;">
								<a href="<?php echo base_url();?>userprofile/tree/<?php echo $result31->USER_REGID; ?>">
						...
						<?php
							...
							?>
							<div style="padding:10px; float:left; width:12.5%; height:180px; text-align:center;">
								<a href="<?php echo base_url();?>userprofile/tree/<?php echo $result32->USER_REGID; ?>">
						...
						<?php
							...
							?>
							<div style="padding:10px; float:left; width:12.5%; height:180px; text-align:center;">
								<a href="<?php echo base_url();?>userprofile/tree/<?php echo $result41->USER_REGID; ?>">
						...
						<?php
							...
							?>			
							<div style="padding:10px; float:left; width:12.5%; height:180px; text-align:center;">
								<a href="<?php echo base_url();?>userprofile/tree/<?php echo $result42->USER_REGID; ?>">
						...
						<?php
							...
							?>			
							<div style="padding:10px; float:left; width:12.5%; height:180px; text-align:center;">
								<a href="<?php echo base_url();?>userprofile/tree/<?php echo $result51->USER_REGID; ?>">
						...
						<?php
							...
							?>				
							<div style="padding:10px; float:left; width:12.5%; height:180px; text-align:center;">
								<a href="<?php echo base_url();?>userprofile/tree/<?php echo $result52->USER_REGID; ?>">
						...
						<?php
							...
							?>						
							<div style="padding:10px; float:left; width:12.5%; height:180px; text-align:center;">
								<a href="<?php echo base_url();?>userprofile/tree/<?php echo $result61->USER_REGID; ?>">
						...
						<?php
							...
							?>			
							<div style="padding:10px; float:left; width:12.5%; height:180px; text-align:center;">
								<a href="<?php echo base_url();?>userprofile/tree/<?php echo $result62->USER_REGID; ?>">
